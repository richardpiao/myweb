...
const backgroundColor = [
  "rgb(97, 218, 251,1)", ////blue/////
  "rgb(65, 184, 131,1)", //////////green/////
  "rgb(223, 176, 122,1)", //////orange /////
  "rgb(221, 0, 49,1)" /////red//////////
];
/* ====================== */
/* ====== VARIABLES ===== */
...
let DOTS_AMOUNT = 1000; // Amount of dots on the screen
let DOT_RADIUS = 2; // Radius of the dots
...
class Dot {
  ...
  draw(sin, cos) {
    ...
    ctx.beginPath();
    ctx.shadowColor = backgroundColor[index];
...
function onResize() {
  ...
  resizeTimeout = window.setTimeout(afterResize, 100);
}
